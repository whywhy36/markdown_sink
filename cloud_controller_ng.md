...
### LIST UserProvidedServiceInstances

Resource URL: `GET /v2/user_provided_service_instances`

Returns a paginated response of UserProvidedServiceInstances.
...
The schema for the `:entity` hash for UserProvidedServiceInstance is:
...
### CREATE UserProvidedServiceInstance

Resource URL: `POST /v2/user_provided_service_instances`

Creates a UserProvidedServiceInstance.
...
### UPDATE UserProvidedServiceInstance

Resource URL: `PUT /v2/user_provided_service_instances`

Updates a UserProvidedServiceInstance.
...
### GET UserProvidedServiceInstance

Resource URL: `GET /v2/user_provided_service_instances/:guid`

Reads a UserProvidedServiceInstance.
...
### DELETE UserProvidedServiceInstance

Resource URL: `DELETE /v2/user_provided_service_instances/:guid`

Deletes a UserProvidedServiceInstance.
